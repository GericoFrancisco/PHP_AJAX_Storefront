...
$html = "<div class='women-title-item-cont'>Women Section</div><table><tr>";
...
for ($i = 0; $i < $limit; $i++) { 
    ...
    if($i < 3){
        ...
        <div class='women-sec-img' onclick='singleDisplay(\"$productCode\")'>
            <img src='$imagePath'>
        </div>
        <div class='women-sec-desc'>
...
$html .= "</tr></table>
            ...
            <button class='prev-btn' onclick='backWomenPage(\"$backPage\");'><i class='fas fa-arrow-left'></i></button>";

            for ($i=1; $i < 4; $i++) { 
                if($i == $page){
                    // $html .= "<input type='text' id='page-number' class='pageNo' value='$i' readonly></input>";
                    $html .= "<input type='text' id='selected-page-number' class='pageNo' value='$i' readonly></input>";
                }else{
                    $html .= "<input type='text' id='page-number' class='pageNo' value='$i' onclick='setWomenPage(\"$i\")'  readonly></input>";
                }
            }

$html .= " <button class='next-btn' onclick='nextWomenPage(\"$nextPage\");'><i class='fas fa-arrow-right'></i></button>
</div>";
...
//     <button class='next-btn' onclick='nextWomenPage(\"$nextPage\");'><i class='fas fa-arrow-right'></i></button>
// </div>";
